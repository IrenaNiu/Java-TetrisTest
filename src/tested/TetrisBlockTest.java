...
public class TetrisBlockTest {
	...
	public void testGetRandomBlock() {
		TetrisBlock a = TetrisBlock.getRandomBlock();
		Vector<TetrisBlock> types = new Vector<TetrisBlock>();
		types.add(TetrisBlock.LEFT_L);
		types.add(TetrisBlock.LONG);
		types.add(TetrisBlock.RIGHT_L);
		types.add(TetrisBlock.SQUARE);
		types.add(TetrisBlock.TEE);
		assertTrue(types.contains(a)); // Random type should be within the list
	}
	...
	public void testToString() {
		String expected1 = TetrisBlock.LEFT_L.toString();
		String expected2 = TetrisBlock.LONG.toString();
		String expected3 = TetrisBlock.RIGHT_L.toString();
		String expected4 = TetrisBlock.SQUARE.toString();
		String expected5 = TetrisBlock.TEE.toString();
